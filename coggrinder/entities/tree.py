...
class TreeNode(DeclaredPropertiesComparable):
    ...
    def clean_clone(self):
        ...
        # which this node belongs to (which  would happen should it have to 
        # follow the parent and children refs).
        orig_parent = self.parent
        orig_children = [x for x in self.children]
        self.parent = None
        del self.children[:]
        
        # Make a complete clone of this tree_node, without the parent and 
        # children properties defined.
        clone = copy.deepcopy(self)
        
        # Reset the parent and children properties.
