...
from coggrinder.services.task_services import GoogleServicesTaskListService, GoogleServicesTaskService
...
class ConsoleTestUtil(object):
    ...
    def create_tasklist_service(cls):
        ...
        tasklist_service.service_proxy = cls.create_gtasks_service_proxy().tasklists()
    ...
    def create_task_service(cls):
        ...
        task_service.service_proxy = cls.create_gtasks_service_proxy().tasks()
